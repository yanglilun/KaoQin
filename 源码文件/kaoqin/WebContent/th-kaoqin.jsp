...
<html>
	...
	<body>
		<div class="container">
			...
			<p class="text-danger text-center">${subname }</p>
			<div class="line">
				<span class="col-xs-5">选择班级:</span>
				<select name="classid" class="class col-xs-5 col-xs-offset-2">
...
// 				判断是否存在班级和周次
				...
				$('select[name=week]').on('change',function(){
					...
					$.post('late','method=THload&week='+week+'&classid='+classid,function(data){
						if(data=='true'){
